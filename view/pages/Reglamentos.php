<?php $reuniones = ControladorFormularios::ctrVerReuniones(); ?>
...
<div class="card">
	...
	<div class="card-body p-4">
		<div class="table-responsive">
			<table class="table" id="reglamento">
				<thead>
					<tr>
						<th>Titulo</th>
				...
				<tbody>
					<?php foreach ($reuniones as $reunion):
						$cantidades = ControladorFormularios::ctrVerReunion($reunion['idTitles'])
					?>
					<tr>
						<td><?php echo $reunion['name_title'] ?>
							<a class="
							btn
							rounded-pill
							px-2
						...
						<td><?php echo $cantidades['NumeroDeCapitulos'] ?>
							...
							waves-effect waves-light
							"
							href = "Capitulos&reglament=<?php echo $reunion['idTitles'] ?>">
