document.addEventListener("DOMContentLoaded", function () {
	...
	if ('#Add-Articulo' !== '') {
		$('#add-articulo-btn').click(function() {
			var addarticle = $("#add-articulo-form").serialize();
			$.ajax({
					...
					if (response === 'ok') {
						...
						$("#form-result").html(`
							<div class='alert alert-danger' role="alert" id="alerta">
								<b>Error</b>, Campo vacio, Llena el campo del articulo.
							</div>
						`);
						deleteAlert();
					}
						...
						$("#form-result").html(`
							<div class='alert alert-danger' role="alert" id="alerta">
								<b>Error</b>, no se pudo crear el articulo, intentalo nuevamente.
							</div>
						`);
						deleteAlert();
					}
